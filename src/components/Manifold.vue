      ...
      >
        <div class="sm:w-3/5 mb-4 sm:mb-0">
          ...
          <p class="my-0 text-gray-600 text-xs">
            Main sensor: {{ manifoldProp.mainSensor }}
          </p>
          <p class="my-0 text-gray-600 text-xs">
            Main actor: {{ manifoldProp.mainActor }}
          </p>
        </div>
      ...
      >
        <div class="sm:w-3/5 mb-4 sm:mb-0">
          <h2 class="text-gray-800 text-lg font-bold truncate">
            {{ manifoldProp.vesselController }}
          </h2>
        </div>
      </div>
      <div class="flex flex-col items-center p-3">
        <div class="flex w-full justify-center">
          <ToggleButton v-bind:controllerId="manifoldProp.id" />
        </div>
      </div>
    </div>
  </div>
...
export default class Vessel extends Vue {
  ...
  @Prop() manifoldProp!: manifoldProp;
  ...
  get dispName(): string {
    return capitalizeFirstLetter(this.manifoldProp.id)
  }
